    ...
    <div className="relative flex items-center">
      ...
      >
        ...
        <a target="_blank" href="https://www.google.com/">
          <button className="text-[10px] md:text-sm text-center p-2 mt-2 bg-lightRoseBrown hover:bg-darkRoseBrown transition-colors duration-500 ease-in-out rounded">
            Download CV
          </button>
        </a>
      </motion.div>
